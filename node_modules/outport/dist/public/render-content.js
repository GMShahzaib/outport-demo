...
function populateBaseUrls(urls) {
...
function populateHeaderInformation(values) {
...
function populateApiEndpoints(apis, timeout) {
...
function buildApiSection(name, endpoints, timeout) {
...
function buildEndpointSection(endpoint, timeout) {
...
function buildRequestSection(endpointId, endpoint, timeout) {
    return `
    <div class="dull-card">
...
function buildResponseSection(endpointId, endpoint) {
    return `
...
function buildRequestTabs(endpointId, endpoint) {
    return `
...
function buildRequestBodyContent(endpointId, body) {
...
function buildResponseTabs(endpointId) {
    return `
...
function buildResponseBodyContent(endpointId) {
    return `
...
function extractRequestBody(body) {
    return (body?.data || []).reduce((acc, { key, value }) => {
        acc[key] = value;
        return acc;
    }, {});
}
function buildFormDataField(data) {
    return `
  <tr class="data-row">
    <td class="data-cell">
        <div class="flex-box">
...
function buildRequestParameters(endpointId, parameters) {
    return `
...
function buildResponses(endpointId, responses) {
    return `
    <div class="dull-card">
      <div class="pointer">
        <h4>Responses:</h4>
